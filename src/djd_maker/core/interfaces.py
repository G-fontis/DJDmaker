...
class NotebookEngine(Protocol):
    ...
    def generation_is_complete(self, job: Job) -> bool: ...

    def download_to_raw(self, job: Job, raw_destination: Path) -> MediaResult: ...

    def delete_remote_video(self, job: Job, gate: DownloadSafetyGate) -> None: ...
