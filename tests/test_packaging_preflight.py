...
def test_spec_is_windowed_onedir_and_build_script_never_creates_zip() -> None:
    ...
    assert 'name="DJDmaker_v0.1.1"' in spec
    ...
    assert "ProductVersion', u'0.1.1'" in version_info
    assert "FileVersion', u'0.1.1.0'" in version_info
